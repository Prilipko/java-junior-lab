...
public class KfkStreams {
    ...
    public KStream<Long, VisitEventEx> visitWithStudentsStream(StreamsBuilder streamsBuilder,
                                                               ...
                                                               @Qualifier("visitWithoutAdditionalGlobalKTable") GlobalKTable<Long,
                                                                       VisitEventEx> visitWithoutAdditionalGlobalKTable
                                                              ) {
        ...
        KStream<Long, VisitEventEx> resultStream =
                stream.peek((key, value) -> log.info("GKT1: {}", value))
